...
nx, ny, nz = 16, 16, 16  # Lower resolution for 3D
...
# Define the capacity
capacity = Capacity(oscillating_body, STmesh; method="VOFI", integration_method=:vofijul, compute_centroids=true)
