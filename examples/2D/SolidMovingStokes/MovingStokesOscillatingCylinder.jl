...
capacity_ux = Capacity(body, STmesh_ux; compute_centroids=true, method="VOFI", integration_method=:vofijul)
capacity_uy = Capacity(body, STmesh_uy; compute_centroids=true, method="VOFI", integration_method=:vofijul)
capacity_p = Capacity(body, STmesh_p; compute_centroids=true, method="VOFI", integration_method=:vofijul)
