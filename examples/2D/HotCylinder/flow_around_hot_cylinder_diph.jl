...
diphasic advection–diffusion run so the cylinder interior temperature is
explicitly resolved. The script saves velocity and temperature snapshots,
a simple animation, and a VTK dump for inspection.
"""
...
save("hot_cylinder_velocity_diph.png", fig_vel)
...
save("hot_cylinder_temperature_snapshots_diph.png", fig_T)
...
record(fig_anim, "hot_cylinder_temperature_diph.mp4", 1:length(states); framerate=12) do frame
